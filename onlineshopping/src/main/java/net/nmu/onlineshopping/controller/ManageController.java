...
import net.nmu.onlineshopping.util.FileUploadUtlility;
...
public class ManageController {
	...
	public ModelAndView showManageProducts(@RequestParam(name = "operation", required = false) String operation) {
		...
		if (operation != null) {
			...
			if (operation.equals("product")) {
		     ...
		     else if(operation.equals("product1"))
			{
				mv.addObject("message", "Product Edited Successfully");
	...
	public String handleProductSubmission(@Valid @ModelAttribute("product") Product mProduct, BindingResult results,Model model,HttpServletRequest request) {
		...
		FileUploadUtlility.uploadFile(request,mProduct.getFile(),mProduct.getCode());	
		...
		return "redirect:/manage/products?operation=product";
			...
			return "redirect:/manage/products?operation=product1";
		}		
	...
	public String handleCategorySubmission(@Valid @ModelAttribute("category") Category category) {
